...
# The code below calculates the statistics of the games run.

p1 = 0
p2 = 0
draw = 0

tests = 1000 # <---- change this value to changes the number of tests run!

print("Games running, please standby...")
for i in range (0, tests):
    shuffledDeck = shuffle(officialDeck) #shuffles the original deck
    p1Deck, p2Deck = splitDeck(shuffledDeck)
    result = playGame(p1Deck, p2Deck)
    if result == "Draw":
        draw += 1
    elif result == "P1":
        p1 += 1
...
p1Percent = (p1 / tests) * 100 // 1
p2Percent = (p2 / tests) * 100 // 1
drawPercent = (draw / tests) * 100 // 1

print("Out of " + str(tests) + " games: ")
print("Player 1 won " + str(p1) + " times, or about " + str(p1Percent) + " percent of the time!" )
print("Player 2 won " + str(p2) + " times, or about " + str(p2Percent) + " percent of the time!")
print("The games ended in a draw " + str(draw) + " times, or about " + str(drawPercent) + " percent of the time!")